                      ...
                      <div className="group-feed">
                        <div className="group-avatar">
                          ...
                          <figure className="group-dp">
                            {" "}
                            <img src="/images/avatar/uocAvatar.jpg" alt="" />
                          </figure>
                        </div>
                        <div className="grp-info about">
                          <h4>
                            Nguyễn Ngọc Ước <span>@uocnnse140739</span>
                          </h4>
                          <ul className="joined-info">
                            ...
                            <li>
                              <span>Số nhóm đã tham gia:</span> 3
                            </li>
                            <li>
                              <span>Số bài viết:</span> 4
                            </li>
                            <li>
                              <span>Số tiền donate đã nhận:</span> 1200000000
                            </li>
                          </ul>
                                      ...
                                      <div className="widget stick-widget">
                                        ...
                                        <ul className="suggestd">
                                          <li>
                                            ...
                                            >
                                              <img
                                                src="/public/images/resources/sug-page-1.jpg"
                                                alt=""
                                              />
                                            </a>
                                            <a
