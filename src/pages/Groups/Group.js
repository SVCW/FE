                                            ...
                                            <div className="row col-xs-6">
                                                <div className="col-lg-3 col-md-4 col-sm-4">
                                                    <div className="group-box">
                                                        <figure><img style={{width:"120px", height:"120px", objectFit:"contain"}} alt src="images/resources/group1.jpg" /></figure>
                                                        <a title href="#">Sports Punch</a>
                                                        <span>125 người thích</span>
                                                        <button><NavLink to='groupsdetail'>Theo dõi</NavLink> </button>
                                                    </div>
                                                </div>
                                                <div className="col-lg-3 col-md-4 col-sm-4">
                                                    <div className="group-box">
                                                        <figure><img style={{width:"120px", height:"120px", objectFit:"contain"}} src="images/resources/group2.jpg" alt /></figure>
                                                        <a href="#" title>Asian Girls</a>
                                                        <span>12 người thích</span>
